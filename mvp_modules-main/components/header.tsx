...
import { isInApp } from "@/lib/integrations/platform-detection";
            ...
            {loading ? (
              ...
              <div className="space-y-1 py-2">
                {sessions.map((session) => (
                  <div
                    key={session.id}
                    className={`group flex items-center gap-2 px-3 py-2 rounded-md cursor-pointer hover:bg-gray-100 transition-colors ${currentSessionId === session.id ? "bg-blue-50" : ""
                      }`}
